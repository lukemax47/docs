...
REACT_APP_PASSWORD_SECRET_KEY=FJexuTITEw
REACT_APP_WALLET_NAME=INCOGNITO_WALLET
REACT_APP_HOME_CONFIG=true
REACT_APP_VERSION=1.0
```

For this template wallet, we have default configuration for envirnoment staging and production.

Here is the code to define constant value staging & production

https://github.com/incognitochain/incognito-extention-wallet/blob/develop/src/constants/config.ts
